...
def main():
  ...
  parser.add_option("-q", "--queue", dest="queue", action='store', default='8nh', help="LXBatch queue (choose among cmst3 8nm 1nh 8nh 1nd 1nw). Default is '1nh' (This parameter is optional)", metavar="QUEUE")
