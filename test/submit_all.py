...
def main():
    ...
    config.General.workArea = 'crabProjects/QCDMuEnriched/withTrackInfo'
    ...
    config.Data.outLFNDirBase = '/store/user/eschmitz/BTV/Spring15/QCDMuEnriched/withTrackInfo/'
...
#    datasetsFile = open( options.datasets )
    datasetsFile = open( './crabScripts/QCDMuEnriched/QCDMuDatasets.txt' )
    ...
    for ijob, job in enumerate(jobs) :
        ...
        ptbin = job.split('/')[1]
        cond = job.split('/')[2]
        config.General.requestName = 'recobtag74Xv2-00_withTrackInfo_' + ptbin + '_' + cond
