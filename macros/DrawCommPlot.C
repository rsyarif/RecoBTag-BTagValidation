...
// TString filename    ="/uscms_data/d3/rsyarif/FermilabSummer2015/HbbTagValidation/CMSSW_7_4_5/src/MyAnalysis/BTagValidation/test/sandbox/condor_jobs/QCDMuEnriched_ptmin-100_doubleMuTag/Final_histograms_btagval.root";
// TString filename    ="/uscms_data/d3/rsyarif/FermilabSummer2015/HbbTagValidation/CMSSW_7_4_5/src/MyAnalysis/BTagValidation/test/sandbox/condor_jobs/QCDMuEnriched_ptmin-100_singleMuTag/Final_histograms_btagval.root";
// TString filename    ="/uscms_data/d3/rsyarif/FermilabSummer2015/HbbTagValidation/CMSSW_7_4_5/src/MyAnalysis/BTagValidation/test/sandbox/condor_jobs/QCDincl_ptmin-100_doubleMuTag/Final_histograms_btagval.root";
TString filename    ="/uscms_data/d3/rsyarif/FermilabSummer2015/HbbTagValidation/CMSSW_7_4_5/src/MyAnalysis/BTagValidation/test/sandbox/condor_jobs/QCDincl_ptmin-100_singleMuTag/Final_histograms_btagval.root";
...
// TString dir4plots   ="HbbTagVal_EventSelStudies_Normalized_Condor/QCDMuEnriched_ptmin-100_doubleMuTag_linear";
// TString dir4plots   ="HbbTagVal_EventSelStudies_Normalized_Condor/QCDMuEnriched_ptmin-100_singleMuTag_linear";
// TString dir4plots   ="HbbTagVal_EventSelStudies_Normalized_Condor/QCDincl_ptmin-100_doubleMuTag_linear";
TString dir4plots   ="HbbTagVal_EventSelStudies_Normalized_Condor/QCDincl_ptmin-100_singleMuTag_linear";
...
void DrawAll(bool Draw_track_plots, bool Draw_Nminus1_plots, bool Draw_sv_plots, bool Draw_muons_plots, bool Draw_discriminator_plots, bool Draw_tagRate_plots, bool Draw_2D_plots, TString histoTag) {
  ...
  if (Draw_muons_plots){
    ...
    DrawStacked(histoTag+"_muon_Pt",        "Muon p_{T} [GeV/c]"             ,logy ,dodata ,extNorm ,0. ,1, 0. ,100.);
