...
void fix(TH1* histo) {
  ...
  if(histo->GetBinContent(1)!=0.)
    errval+=TMath::Power(histo->GetBinError(1)/histo->GetBinContent(1),2);
  if(histo->GetBinContent(0)!=0.)
    errval+=TMath::Power(histo->GetBinError(0)/histo->GetBinContent(0),2);
  errval=TMath::Sqrt(errval)*val;
  ...
  if(histo->GetBinContent(highbin)!=0.)
    errval+=TMath::Power(histo->GetBinError(highbin)/histo->GetBinContent(highbin),2);
  if(histo->GetBinContent(highbin+1)!=0.)
    errval+=TMath::Power(histo->GetBinError(highbin+1)/histo->GetBinContent(highbin+1),2);
  errval=TMath::Sqrt(errval)*val;
